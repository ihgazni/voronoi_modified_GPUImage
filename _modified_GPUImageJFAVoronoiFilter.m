...
-(void) setInitStep:(CGFloat)initStep {
    
    _initStep = initStep;
    
    glUniform1f(sampleStepUniform, _initStep);
...
- (void)renderToTextureWithVertices:(const GLfloat *)vertices textureCoordinates:(const GLfloat *)textureCoordinates;
{
    ...
    {
        NSLog(@"usingNextFrameForImageCapture");
    ...
    /*
   //// while (pow(2,numPasses) < _sizeInPixels.width) {
